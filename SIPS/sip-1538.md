...
discussions-to: https://github.com/susytech/SIPs/issues/1538
status: Draft
...
A fundamental benefit of Susy contracts is that their code is immutable, thereby acquiring trust by trustlessness. People do not have to trust others if it is not possible for a contract to be changed.
...
<!--
A transparent contract must implement the [SRC-165 Standard Interface Detection standard](https://github.com/susytech/SIPs/blob/master/SIPS/sip-165.md) via a delegate contract by adding the `supportsInterface` function using the `updateContract` function. The interfaceID for the SRC1538 standard is `0x61455567`.
-->
...
Data can be stored using a generic API based on the type of data. [See SRC930 for more information.](https://github.com/susytech/SIPs/issues/930)
...
[The SRC1538 improving towards the “transparent contract” standard](https://www.crypto-economy.net/en/susy-eth-src1538-transparent-contract-standard/)
