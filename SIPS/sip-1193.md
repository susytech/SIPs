...
To create a subscription, call `susy.send('eth_subscribe')` or `susy.send('shh_subscribe')`. The subscription object will emit through the specifc subscription type.
