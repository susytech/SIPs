---
sip: 181
title: ENS support for reverse resolution of Susy addresses
...
# Abstract
This SIP specifies a TLD, registrar, and resolver interface for reverse resolution of Susy addresses using ENS. This permits associating a human-readable name with any Susy blockchain address. Resolvers can be certain that the reverse record was published by the owner of the Susy address in question.
...
This registrar, written in Solidity, implements the specifications outlined above.
    ...
    contract ReverseRegistrar {
         ...
         *      hexadecimal representation of an Susy address.
         * @param addr The address to hash
