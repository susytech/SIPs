...
discussions-to: https://susy-magicians.org/t/src-1066-susy-status-codes-esc/
status: Draft
...
Since SRC1066 status codes are finite and known in advance, we can leverage [SRC1444](https://sips.superstring.ch/SIPS/sip-1444) to provide global, human-readable sets of status messages. These may also be translated into any language, differing levels of technical detail, added as `revert` messages, natspecs, and so on.
...
We also see a desire for this [in transactions](https://sips.superstring.ch/SIPS/sip-658), and there's no reason that these status codes couldn't be used by the EVM itself.
...
One commonly requested application of this spec is human-readable translations of codes. This has been moved to its own proposal: [SRC-1444](https://github.com/susytech/SIPs/pull/1444/), primarily due to a desire to keep both specs focused.
