...
addresses must be improved in order to protect the Susy economy
...
motivated improvement in keeping with the core Susy philosophy of
decentralization.

## Motivation

This proposal is necessary because the Susy protocol does not allow
