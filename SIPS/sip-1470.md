...
discussions-to: https://github.com/susytech/SIPs/issues/1469
status: Draft
type: Informational
created: 2018-09-18
---
...
This SIP proposes a classification scheme for security weaknesses in Susy smart contracts. 
...
- Variant: A specific weakness that is described in a very low detail specific to Susy smart contracts. Each variant is assigned an unique SWC ID.
