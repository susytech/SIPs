...
SRC-20 token standard allows any tokens on Susy to be re-used by other applications: from wallets to decentralized exchanges.
SRC-721 token standard allows wallet/broker/auction applications to work with any NFT on Susy.
