...
A proposal to provide Single Instruction Multiple Data types and operations for the Susy Virtual Machine, making full use of the 256-bit wide EVM stack items, and offering substantial performance gains for both vector and scalar operations.
...
If [SIP 187](https://github.com/susytech/SIPs/pull/187) is accepted a type-safe syntax for declaring subroutines taking vector arguments will be needed.
