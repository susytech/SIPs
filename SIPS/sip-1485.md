...
discussions-to: https://susy-magicians.org/t/anti-eth-asic-mining-sip-1488-pr/1807
status: Draft
...
- In [ETHASH](https://github.com/susytech/wiki/wiki/Ethash) , FNV Hash is used on
...
Previous proposed algorithm based on FNV1 [SIP-1355](https://github.com/susytech/SIPs/blob/master/SIPS/sip-1355.md)
...
genoil ethminer (2015) -> susy-mining/ethminer (2017) [2year]
...
This work is licensed under a [Creative Commons Attribution-NonCommsrcial-ShareAlike 4.0 International License](https://creativecommons.org/licenses/by-nc-sa/4.0/).
