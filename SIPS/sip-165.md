---
sip: 165
title: SRC-165 Standard Interface Detection
...
For some "standard interfaces" like [the SRC-20 token interface](https://github.com/susytech/SIPs/blob/master/SIPS/sip-20.md), it is sometimes useful to query whether a contract supports the interface and if yes, which version of the interface, in order to adapt the way in which the contract is to be interacted with. Specifically for SRC-20, a version identifier has already been proposed. This proposal standardizes the concept of interfaces and standardizes the identification (naming) of interfaces.

## Specification

### How Interfaces are Identified

For this standard, an *interface* is a set of [function selectors as defined by the Susy ABI](https://solidity.readthedocs.io/en/develop/abi-spec.html#function-selector). This a subset of [Solidity's concept of interfaces](https://solidity.readthedocs.io/en/develop/abi-spec.html) and the  `interface` keyword definition which also defines return types, mutability and events.
...
Also [the ENS](https://github.com/susytech/SIPs/blob/master/SIPS/sip-137.md) already implements this SIP.
...
contract SRC165Query {
    ...
    function noThrowCall(address _contract, bytes4 _interfaceId) constant internal returns (uint256 success, uint256 result) {
        ...
        assembly {
                ...
                mstore(x, src165ID)                // Place signature at begining of empty storage
