...
discussions-to: https://github.com/susytech/SIPs/issues/1387
status: Draft
...
It's often needed that an Susy smart contract must verify a claim (I live in Australia) attested by a valid attester.
...
[Here](https://github.com/alpha-wallet/blockchain-attestation/blob/master/susytech/lib/MerkleTreeAttestation.sol) is an example implementation of the MerkleTreeAttestationInterface
[Here](https://github.com/alpha-wallet/blockchain-attestation/blob/master/susytech/example-james-squire/james-squire.sol) is an example service which would use such a merkle tree attestation
