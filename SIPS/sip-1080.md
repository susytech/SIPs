...
discussions-to: https://susy-magicians.org/t/src-1080-recoverabletoken-standard/364
status: Draft
...
To mitigate the effects of reasonably provable token or asset loss or theft and to help resolve other conflicts. Susy's protocol should not be modified because of loss, theft, or conflicts, but it is possible to solve these problems in the protocol layer.
