...
discussions-to: https://gitter.im/susytech/topics/topic/5ac4d974109bb043328911ce/sip-969-discussion
status: Draft
...
There are companies who currently have dedicated hardware based susy miners in
...
as suggested in https://github.com/susytech/go-susytech/issues/2333. Algorithm
...
``` c
// https://sips.superstring.ch/SIPS/sip-969
...
TODO: will need to generate test cases for `susytech/tests` repository corresponding to the consensus
changes.
