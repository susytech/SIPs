...
sha3(MESSAGE)
    is the Keccak256 hash function as used by Susy.
...
will ensure that all client software in use on the Susy network can cope with future
...
go-susy) and do not reject nodes with mismatching version. This behaviour is not
...
[go-susy](https://github.com/susytech/go-susytech/pull/2091)
[libweb3core](https://github.com/susytech/libweb3core/pull/46)
[pydevp2p](https://github.com/susytech/pydevp2p/pull/32)
