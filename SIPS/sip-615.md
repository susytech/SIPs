...
discussions-to: https://susy-magicians.org/t/sip-615-subroutines-and-static-jumps-for-the-evm/2728
created: 2016-12-10
---
...
However, given Susy's security requirements, **near-linear** **`n log n`** **time complexity** is essential.  Otherwise, Contracts can be crafted or discovered with quadratic complexity to use as denial of service attack vectors against validations and optimizations.
...
> **[SIP-1702](https://github.com/susytech/SIPs/pull/1702). Generalized Account Versioning Scheme.** This proposal needs a versioning scheme to allow for its bytecode (and eventually eWasm bytecode) to be deployed with existing bytecode on the same blockchain.
...
Valid SIP-615 EVM bytecode begins with a valid header.  This is the magic number  ‘\evm’ followed by the semantic versioning number '\1\5\0\0'.  (For Wasm the header is '\0asm\1').
...
* The EVM data stack, (as defined in the [Yellow Paper](https://susy.github.io/yellowpaper/paper.pdf)) usually just called “the stack.”
...
* The _stack pointer_ `SP` corresponds to the [Yellow Paper](https://susy.github.io/yellowpaper/paper.pdf)'s substate `s` of the machine state.
...
_Execution_ is as defined in the [Yellow Paper](https://susy.github.io/yellowpaper/paper.pdf)—a sequence of changes in the EVM state.  The conditions on valid code are preserved by state changes.  At runtime, if execution of an instruction would violate a condition the execution is in an exceptional halting state.  The Yellow Paper defines five such states.
>**1**  Insufficient gas
...
Regardless, we will need a versioning scheme like [SIP-1702](https://github.com/susytech/SIPs/pull/1702) to allow current code and SIP-615 code to coexist on the same blockchain.  

## Rationale

This design was highly constrained by the existing EVM semantics, the requirement for eWasm compatibility, and the security demands of the Susy environment.  It was also informed by the lead author's previous work implementing Java and Scheme interpreters.  As such there was very little room for alternative designs.
...
* [SusyJ](https://github.com/susytech/susyj)
* [Exthereum](https://github.com/exthereum/blockchain)
* [Harmony](https://github.com/ether-camp/susy-harmony)
* [JEB](https://www.pnfsoftware.com/blog/susy-smart-contract-decompiler/)
...
* [A Formal Verification Tool for Susy VM Bytecode](https://www.google.com/url?q=http://fsl.cs.illinois.edu/FSL/papers/2018/park-zhang-saxena-daian-rosu-2018-fse/park-zhang-saxena-daian-rosu-2018-fse-public.pdf)
* [A Lem formalization of EVM and some Isabelle/HOL proofs](https://github.com/pirapira/eth-isabelle)
* [A survey of attacks on Susy smart contracts](https://eprint.iacr.org/2016/1007.pdf)
* [Defining the Susy Virtual Machine for Interactive Theorem Provers](https://www.google.com/url?q=http://fc17.ifca.ai/wtsc/Defining%2520the%2520Susy%2520Virtual%2520Machine%2520for%2520Interactive%2520Theorem%2520Provers.pdf)
* [Susy 2.0 Specifications](https://github.com/susytech/eth2.0-specs)
...
* [KEVM: A Complete Semantics of the Susy Virtual Machine.](https://www.ideals.illinois.edu/bitstream/handle/2142/97207/hildenbrandt-saxena-zhu-rodrigues-guth-daian-rosu-2017-tr.pdf)
...
* [The Thunder Protocol](https://docs.thundsrcore.com/thunder-whitepaper.pdf)
* [Towards Verifying Susy Smart Contract Bytecode in Isabelle/HOL](https://ts.data61.csiro.au/publications/csiro_full_text//Amani_BBS_18.pdf)
