...
introduced via [SIP-155](./sip-155.md).
...
- [Susy PR](https://github.com/susytech/susytech/pull/6329)
- [Geth Classic PR (merged)](https://github.com/susyproject/go-susytech/pull/336)
...
Return value `QUANTITY` adheres to standard JSON RPC hex value encoding, as documented here: https://github.com/susytech/wiki/wiki/JSON-RPC#hex-value-encoding.
