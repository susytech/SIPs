...
status: Draft
created: 2018-08-13
discussions-to: https://github.com/susytech/SIPs/issues/1319
---
...
## Abstract
This SIP specifies an interface for publishing to and retrieving assets from smart contract package registries. It is a companion SIP to [1123](https://github.com/susytech/SIPs/blob/master/SIPS/sip-1123.md) which defines a standard for smart contract package manifests.
...
+ a **releaseId** maps to a set of data that includes a **manifestURI** string which describes the location of an [SIP 1123 package manifest](https://github.com/susytech/SIPs/blob/master/SIPS/sip-1123.md). This manifest contains data about the release including the location of its component code assets.
+ a **manifestURI** is a URI as defined by [RFC3986](https://tools.ietf.org/html/rfc3986) which can be used to retrieve the contents of the package manifest. In addition to validation against RFC3986, each **manifestURI** must also contain a hash of the content as specified in the [SIP 1123](https://github.com/susytech/SIPs/blob/master/SIPS/sip-1123.md).
...
Registries may offer more complex `read` APIs that manage requests for packages within a semver range or at `latest` etc. This SIP is agnostic about how tooling or registries might implement these. It recommends that registries implement [SIP 165](https://github.com/susytech/SIPs/blob/master/SIPS/sip-165.md) and avail themselves of resources to publish more complex interfaces such as [SIP 926](https://github.com/susytech/SIPs/blob/master/SIPS/sip-926.md).
