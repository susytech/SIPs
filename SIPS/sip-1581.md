...
discussions-to: https://susy-magicians.org/t/non-wallet-usage-of-keys-derived-from-bip-32-trees/1817
status: Draft
...
## Simple Summary
This SIP describes a derivation path structure for [BIP32](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki) wallets to be used for non-wallet keypairs.
...
This part is constant and set to ```m / 43' / 60' / 1581'```, meaning BIP 43 -> Susy -> This SIP.
