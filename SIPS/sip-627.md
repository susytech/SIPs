...
This SIP should substitute the [existing specification](https://github.com/susytech/wiki/wiki/Whisper-Wire-Protocol).
More detailed documentation on Whisper could be found [here](https://github.com/susytech/go-susytech/wiki/Whisper).
...
This packet is used by Whisper nodes for dynamic adjustment of their individual PoW requirements. Recsipient of this message should no longer deliver the sender messages with PoW lower than specified in this message.
...
The golang implementation of Whisper (v.6) already uses packet codes 0x00 - 0x03. Susy's implementation of v.6 will also use codes 0x00 - 0x03. Codes 0x7E and 0x7F are reserved, but still unused and left for custom implementation of Whisper Mail Server.
