...
| `a`          | `b`          | `r`          | _result_     | _path exsrcised_ |
| ------------ | ------------ | ------------ | ------------ | ---------------- |
...
| `a`          | `b`          | `r`          | _result_     | _operation exsrcised_   |
| ------------ | ------------ | ------------ | ------------ | ----------------------- |
...
### 0.9.2
[Machine-readable data](https://github.com/susytech/SIPs/blob/ad4e73f239d53d72a21cfd8fdc89dc81eb9d2688/assets/sip-1057/test-vectors-0.9.3.json)
